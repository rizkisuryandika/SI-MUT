...
MustInherit Class Theme_ddk_2015
    Inherits ContainerControl

    Dim MoveHeight As Integer = 60 'Tinggi header yg bisa digerakkan
...
#End Region
    ...
    Private Sub FormShown(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If _StartPosition = FormStartPosition.CenterParent OrElse _StartPosition = FormStartPosition.CenterScreen Then
            ...
            ParentForm.Location = New Point(SB.Width \ 2 - CB.Width \ 2, (SB.Height - CB.Height) \ 2)
        End If
...
#Region " Size Handling "
    ...
    Protected NotOverridable Overrides Sub OnSizeChanged(ByVal e As EventArgs)
        If _Movable AndAlso Not _ControlMode Then
            'ddk ATUR yang dapat di drag ----- >
            Frame = New Rectangle(7, 7, Width - 14, _Header + 10)
        End If
...
#Region " State Handling "
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        ...
        If Not (_IsParentForm AndAlso ParentForm.WindowState = FormWindowState.Maximized OrElse _ControlMode) Then
            ...
            If _Sizable AndAlso Not Previous = 0 Then
                Capture = False
                WM_LMBUTTONDOWN = True
...
MustInherit Class ThemeControl_ddk_2015
    Inherits Control
...
Class Theme
    Inherits Theme_ddk_2015


    Sub New()
        'Ubah warna utama disini
        BackColor = Color.FromArgb(53, 157, 181)
        SetColor("content", Color.Gainsboro)
        SetColor("textc", Color.Black)
        'ddk edit --- >' Font = New Font("Segoe UI", 15)
    ...
    Protected Overrides Sub PaintHook()
        Dim WD As Color = Color.LightBlue
        G.Clear(WD)
        G.FillRectangle(New SolidBrush(Color.FromArgb(43, 169, 232)), New Rectangle(1, 1, Width - 2, Height - 2))
        G.FillRectangle(New SolidBrush(BackColor), New Rectangle(2, 2, Width - 4, Height - 4))

        '  G.Clear(BackColor)



        'Gambar Area CONTEN ISI nya
        '  G.FillRectangle(New SolidBrush(content), New Rectangle(1, MoveHeight, Width - 2, Height - MoveHeight - 24))
        ' G.FillRectangle(New SolidBrush(Color.WhiteSmoke), New Rectangle(3, MoveHeight, Width - 6, Height - MoveHeight - 24))
        G.FillRectangle(New SolidBrush(content), New Rectangle(4, MoveHeight + 1, Width - 7, Height - MoveHeight - 26))




        'Tampilkan Titik2 Resize form pojok kanan bawah
        ...
        'Tampilkan Icon Form
        G.DrawIcon(FindForm.Icon, New Rectangle(15, 10, 32, 32))

        'Nama Form TextNya
        DrawText(textc, HorizontalAlignment.Left, 70, 10)
...
Class Theme_metro
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(BackColor)
        G.FillRectangle(New SolidBrush(content), New Rectangle(2, 45, Width - 4, Height - 80))

        G.FillRectangle(New SolidBrush(Color.FromArgb(43, 169, 232)), New Rectangle(0, 0, Width, 2))

        G.DrawIcon(FindForm.Icon, New Rectangle(10, 4, 32, 32))
...
Class Theme_metro_B
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(BackColor)
        G.FillRectangle(New SolidBrush(content), New Rectangle(2, 45, Width - 4, Height - 50))

        G.FillRectangle(New SolidBrush(Color.FromArgb(43, 169, 232)), New Rectangle(0, 0, Width, 2))

        'Tampilkan Icon Form
        G.DrawIcon(FindForm.Icon, New Rectangle(15, 10, 25, 25))

        'Nama Form TextNya
        DrawText(textc, HorizontalAlignment.Left, 44, 10)
...
Class Theme_metro_C
    ...
    Protected Overrides Sub PaintHook()
        ...
        'Tampilkan Icon Form
        G.DrawIcon(FindForm.Icon, New Rectangle(5, 5, 25, 25))

        'Nama Form TextNya
        DrawText(textc, HorizontalAlignment.Left, 35, 5)

    End Sub
End Class

Class Theme_metro_Info

    Inherits Theme_ddk_2015
    Sub New()
        BackColor = Color.FromArgb(53, 157, 181)
        SetColor("content", Color.White)
        SetColor("textc", Color.FromArgb(64, 64, 64))
        SetColor("circlec", Color.White)
        SetColor("circlef", Color.White)
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        Dim WD As Color = Color.WhiteSmoke
        G.Clear(WD)
        G.FillRectangle(New SolidBrush(Color.FromArgb(43, 169, 232)), New Rectangle(1, 1, Width - 2, Height - 2))
        G.FillRectangle(New SolidBrush(Color.WhiteSmoke), New Rectangle(2, 2, Width - 4, Height - 6))

        'Isi
        G.FillRectangle(New SolidBrush(Color.LightGray), New Rectangle(8, 50, Width - 20, Height - 130))
        G.FillRectangle(New SolidBrush(Color.White), New Rectangle(9, 51, Width - 22, Height - 132))

        'Tampilkan Icon Form
        G.DrawIcon(FindForm.Icon, New Rectangle(10, 10, 30, 30))

        'Nama Form TextNya
        DrawText(textc, HorizontalAlignment.Left, 45, 10)
...
Class Theme_metro_D
    ...
    Sub New()
        ...
        SetColor("isi", Color.White)
        SetColor("Teks", Color.FromArgb(65, 65, 65))
        SetColor("circlec", Color.White)
        SetColor("Border1", Color.SteelBlue)
        SetColor("kepala", Color.WhiteSmoke)
    End Sub

    Dim BackGroundIsi As Color
    Dim circlec As Pen
    Dim Border1 As Color
    Dim WarnaKepala As Color
    Dim TextNya As Brush
    Protected Overrides Sub ColorHook()
        BackGroundIsi = GetColor("isi")
        circlec = GetPen("circlec")
        Border1 = GetColor("Border1")
        TextNya = GetBrush("Teks")
        WarnaKepala = GetColor("kepala")
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.FillRectangle(New SolidBrush(Border1), New Rectangle(1, 1, Width - 2, Height - 2))
        G.FillRectangle(New SolidBrush(WarnaKepala), New Rectangle(2, 2, Width - 4, Height - 4))

        'Isi
        G.FillRectangle(New SolidBrush(Color.LightGray), New Rectangle(5, 50, Width - 10, Height - 55))
        G.FillRectangle(New SolidBrush(BackGroundIsi), New Rectangle(6, 51, Width - 12, Height - 57))

        'Tampilkan Icon Form
        G.DrawIcon(FindForm.Icon, New Rectangle(10, 10, 30, 30))

        'Nama Form TextNya
        DrawText(TextNya, HorizontalAlignment.Left, 45, 10)
...
Class Theme_metro_E
    ...
    Sub New()
        BackColor = Color.White
        SetColor("content", Color.White)
        SetColor("textc", Color.FromArgb(65, 65, 65))
        SetColor("circlec", Color.White)
        SetColor("circlef", Color.White)
        SetColor("kepala", Color.WhiteSmoke)
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.Clear(WD)
        G.FillRectangle(New SolidBrush(Color.FromArgb(43, 169, 232)), New Rectangle(1, 1, Width - 2, Height - 2))
        G.FillRectangle(New SolidBrush(Color.WhiteSmoke), New Rectangle(0, 4, Width, Height - 8))
        G.FillRectangle(New SolidBrush(kepala), New Rectangle(1, 3, Width - 2, Height - 8))

        'Isi
        G.FillRectangle(New SolidBrush(Color.WhiteSmoke), New Rectangle(1, 50, Width - 2, Height - 52))
        G.FillRectangle(New SolidBrush(Color.White), New Rectangle(2, 51, Width - 4, Height - 54))
