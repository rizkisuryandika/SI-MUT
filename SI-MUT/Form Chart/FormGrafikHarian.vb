...
Public Class FormGrafikHarian
    ...
    Private Sub get_data()
        Try
            ...
            dt = Data("select MID(tab_hasil.TGL,9,2) as HARI,
                       ...
                       where tab_indruang.ID_RUANG LIKE '" & id_ruang() & "' and 
                             ...
                             LEFT(tab_hasil.TGL,7) = '" & cb_tahun.Text & "-" & convertbln_textkeangka(cb_bln.Text) & "'
					   GROUP BY HARI
